const pocketContents = [
    {
        "name":"Money",
        "variations":['pocket change to them','a normal amount to have on hand for them','a sizable sum for them'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
        }
    ...
    {
        "name":"Important piece of personal paperwork",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"5"
    ...
    {
        "name":"Junk",
        "variations":['pocket lint','a piece of string','a blank scrap of paper','a used napkin','a torn piece of leather','a ball of lint','a wood chip'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"20"
        }
    ...
    {
        "name":"Hand-drawn map to somewhere in the area",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"5"
    ...
    {
        "name":"Unopened letter addressed to them",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
    ...
    {
        "name":"Key",
        "variations":['to their house','to a business','to somewhere important','to a chest'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"5"
        }
    ...
    {
        "name":"Snack",
        "variations":['dried meat','nuts','berries','candy','hard-boiled egg'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
        }
    ...
    {
        "name":"Flask",
        "variations":['full','half-empty','empty'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
        }
    ...
    {
        "name":"One single unique coin",
        "variations":['platinum piece','embedded with a jewel','rare mint','from another country','chocolate'],
        "weight": {
            "plotrelevent":"5",
            "randomnpc":"5"
        }
    ...
    },
    {
        ...
        "variations":['amulet','emblem','ring','reliquary'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
        }
    ...
    {
        "name":"Small wooden figurine",
        "variations":['of a person','of an animal','of a monster'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"10"
        }
    ...
    {
        "name":"Locket with a portrait of someone inside",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"5"
    ...
    {
        "name":"Clue towards solving the current mystery",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"0"
    ...
    {
        "name":"Wanted poster",
        "variations":['an ally of the party','an enemy of the party','a stranger to the party'],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"0"
        }
    ...
    {
        "name":"Note with instructions from the villain",
        "variations":[''],
        "weight": {
            "plotrelevent":"10",
            "randomnpc":"0"
